...
final class TokenBucketSpec {
    ...
    static BandwidthLimit parseBandwidthLimit(String specification) {
        ...
        final long limit = Long.parseLong(specification.substring(0, limitSep));
        final Map<String, String> options = OPTIONS_SPLITTER.split(specification.substring(limitSep + 1));
